...
const totalBuyers = document.querySelector('.total-buyers-value');
const totalSellers = document.querySelector('.total-sellers-value');
const totalAdmins = document.querySelector('.total-admins-value');
  ...
  e.onchange = () => {
    ...
    if (startDate.value && endDate.value) {
      if (new Date(startDate.value).getTime() - new Date(endDate.value).getTime() > 0)
      {
        ...
        totalBuyers.innerText = "..."
          totalSellers.innerText = "..."
      ...
      fetch("get_statistics.php", {
        ...
        .then(data => {
          ...
          totalBuyers.innerText = data.total_buyers;
          totalSellers.innerText = data.total_sellers;
          totalAdmins.innerText = data.total_admins;
        });
    }
  };
});
