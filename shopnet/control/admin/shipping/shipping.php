        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="create-item">
                    <a href="create.php">Create shipping method</a>
                    <div class="search">
                ...
                <table>
                        ...
                        <tbody class="tbody">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                $min_cost =  $row["min_cost"] == '' ? 0 :  $row["min_cost"];
                                echo'
                                ...
                                <td>' . $row["id"] . '</td>
                                 ...
                                 <td><a class="update" href="edit.php?shipping_method_id=' . $row["id"] . '"><i class="fa-solid fa-pen-to-square"></i></a></td>
